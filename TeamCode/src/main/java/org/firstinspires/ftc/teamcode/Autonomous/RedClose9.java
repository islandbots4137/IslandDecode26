...
@Autonomous(name = "Red Close 9", group = "Autonomous")
public class RedClose9 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // ---------- PATHING INIT ----------
        // Mirrored starting pose: x = 144 - 25.6 = 118.4, y stays, heading = 180 - 144 = 36
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            // Original: (54, 89.25) -> ctrl(51.11, 82.318) -> (45.656, 83.75), heading 136.5° -> 180°
            // Mirrored: (90, 89.25) -> ctrl(92.89, 82.318) -> (98.344, 83.75), heading 43.5° -> 0°
            ...
            // Original: (54, 89.25) -> ctrl(49.217, 65.797) -> (48, 61), heading 136.5° -> 180°
            // Mirrored: (90, 89.25) -> ctrl(94.783, 65.797) -> (96, 61), heading 43.5° -> 0°
            ...
            // Original: (57, 92.25) -> (55.784, 113.441), heading 136.5° -> 225°
            // Mirrored: (87, 92.25) -> (88.216, 113.441), heading 43.5° -> -45° = 315°
